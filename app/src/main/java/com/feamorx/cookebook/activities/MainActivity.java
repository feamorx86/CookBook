...
import com.feamorx.cookebook.fragments.CookNowListFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private CookNowListFragment cookNowListFragment;
...
//        createFragments();
        ...
        transaction.add(R.id.content_main, mainScreenFragment, "main_screen");
        transaction.commit();
    }
    ...
    public void selectMenu(MenuItem menuItem) {
        ...
        if (menuItem != null) {
            if (menuItem != lastSelectedMenuItem) {
    ...
    public boolean onMenuItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_settings: {
                ...
                transaction.replace(R.id.content_main, settingsFragment, "settings");
                transaction.commit();
                selectMenu(item);
            }
            break;
